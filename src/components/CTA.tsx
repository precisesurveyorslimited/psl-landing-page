      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row md:items-center justify-between">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <a
              href="#contact"
              className="bg-transparent hover:bg-yellow-800 border-2 border-white text-white font-medium py-3 px-6 rounded-md transition-colors duration-300 flex items-center justify-center"
            >
